...
const Profile = () => {
  return (
	<div className='grid justify-center ' ><div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
